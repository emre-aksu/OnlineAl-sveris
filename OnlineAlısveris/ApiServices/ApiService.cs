...
namespace OnlineAlısveris.ApiServices
{
    public class ApiService : IApiService
    {
        ...
        public async Task<T> GetData<T>(string endPoint, string token = null)
        {
          ...
          var responseObject=  JsonSerializer.Deserialize<T>(jsonResponse,new JsonSerializerOptions() { PropertyNameCaseInsensitive=true});
